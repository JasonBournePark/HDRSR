...
#### [Figure] Visual comparison for an image of natural scene, (a) reference LDR/HR image, (b) interpolated LDR/HR image, (c) super-resolved LDR/HR image, (d-e) HDR/HR images generated by SR(YpUV)-HDR and SR(RGB)-HDR strategies, (f-g) HDR/HR images generated by HDR-SR(YpUV) and HDR-SR(RGB) strategies, (h-n) magnified images of the indicated areas in each image of (a-g).
<br><br>
